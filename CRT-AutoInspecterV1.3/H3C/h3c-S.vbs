...
Sub Main
    ...
    crt.Screen.WaitForString " This operation may take a few minutes, continue?[Y/N]"
    crt.Screen.Send "y" & chr(13)  
    crt.Screen.WaitForString " Diagnostic-information is saved to Flash or displayed(Y=save N=display)?[Y/N]"
