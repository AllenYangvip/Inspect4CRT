...
Sub Main
    ...
    CMDArr(3) = "show env-list"
    CMDArr(4) = "show environment"
    CMDArr(5) = "show interface"
    CMDArr(6) = "show ntp status"
    CMDArr(7) = "show logg buffer"
    CMDArr(8) = "show cpu monitor"
    CMDArr(9) = "show device"
    CMDArr(10) = "show system power"
    CMDArr(11) = "show system fan"
    CMDArr(12) = "show tech-support all"
