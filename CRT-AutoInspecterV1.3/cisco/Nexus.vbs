...
#$interface = "1.0"
' Auth: Yangjh
' Desc: Cisco Nexus device Inspect
' Date: 2019-10-25
' Version: 1.3
' Platform: SecureCRT
...
Sub Main
   ...
   crt.session.Log(true)
    ...
    CMDArr(1) = "show sys resources"
    CMDArr(2) = "show fex"
    CMDArr(3) = "show inventory"
    CMDArr(4) = "show vdc"
    CMDArr(5) = "show vpc"
    CMDArr(6) = "show env"
    CMDArr(7) = "show module"
    CMDArr(8) = "show run"
    CMDArr(9) = "show ntp status"
    CMDArr(10) = "show logging"
    CMDArr(11) = "show environment fex all"
    CMDArr(12) = "show fex detail | SEC Active | FEX:"
    CMDArr(13) = ""
