...
'     2. 输入show version 或者show version 判断该设备是何类型设备什么系统，然后复制好本设备的hostname
...
Sub Main
    ...
    CMDArr(3) = "show power"
    CMDArr(4) = "show fan"
    CMDArr(5) = "show ntp status"
    CMDArr(6) = "show interface"
    CMDArr(7) = "show environment"
    CMDArr(8) = "show logging alarm"
    CMDArr(9) = "show tech-support"
